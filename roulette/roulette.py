...
def getWin(result: int, choice: str, numbers: list = None):
    match choice:
        case "red":
        ...
        case "half2":
            return 19 <= result <= 36
        case "gran serie":
            return result in [0,3,4,7,12,15,18,19,21,22,25,26,28,29,32,35]
        case "serie 5/8":
...
def getMultiplier(win: bool, choice: str, numbers: list = None):
    if win:
        match choice:
